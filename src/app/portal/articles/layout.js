    ...
    <html lang="en">
      ...
      >
        ...
        <nav className="bg-transparent border-gray-200 dark:bg-gray-900">
          <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto sm:px-40 sm:py-10 p-4">
        ...
        <footer className="row-start-3 mt-10 pb-10 flex gap-6 flex-wrap items-center justify-center">
          <small className="font-medium dark:text-white text-neutral-400">@ 2024 - {new Date().getFullYear()} Dimas Nugroho Putro, Build with Next JS and Tailwind</small>
        </footer>
      </body>
    </html>
  );
